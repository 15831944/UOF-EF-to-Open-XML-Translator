...
xmlns:对象="http://schemas.uof.org/cn/2009/objects">
  ...
  <xsl:template name="sldLayoutIdLst" xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main">
    <p:sldLayoutIdLst>
      ...
      <xsl:if test =".//@编号引用_4187=ancestor::uof:UOF/uof:式样集//字:自动编号_4124[字:级别_4112/字:图片符号_411B]/@标识符_4100">
        ...
        <xsl:for-each select ="//字:自动编号_4124[字:级别_4112/字:图片符号_411B]">
          ...
          <xsl:if test ="not(current()/字:级别_4112/字:图片符号_411B=preceding::*/字:图片符号_411B)">
            <Relationship Id="rId2" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/image" Target="../media/image1.gif">
              <xsl:attribute name="Id">
