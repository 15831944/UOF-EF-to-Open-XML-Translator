...
xmlns:图="http://schemas.uof.org/cn/2009/graph">
  ...
  <xsl:template match="p:notes">
    <xsl:variable name="notesMaster" select="substring-after(following-sibling::rel:Relationships[1]/rel:Relationship[@Type='http://schemas.openxmlformats.org/officeDocument/2006/relationships/notesMaster']/@Target,'notesMasters/')"/>
    <xsl:copy>
      <xsl:for-each select="@*">
        <xsl:copy/>
      </xsl:for-each>
  ...
  <xsl:template match="p:sld">
    <p:sld>
      <xsl:variable name="layout" select="substring-after(following-sibling::rel:Relationships[1]/rel:Relationship[@Type='http://schemas.openxmlformats.org/officeDocument/2006/relationships/slideLayout']/@Target,'slideLayouts/')"/>
      <xsl:attribute name="sldLayoutID">
        <xsl:value-of select="$layout"/>
      </xsl:attribute>
		<xsl:if test="following-sibling::rel:Relationships[1]/rel:Relationship[@Type='http://schemas.openxmlformats.org/officeDocument/2006/relationships/comments']">
			
		<xsl:variable name="comment" select="substring-after(following-sibling::rel:Relationships[1]/rel:Relationship[@Type='http://schemas.openxmlformats.org/officeDocument/2006/relationships/comments']/@Target,'comments/')"/>
