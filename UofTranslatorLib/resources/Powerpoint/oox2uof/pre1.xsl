...
-->
  ...
  <!--新增功能点smartart liqiuling 2012.12.11 start-->
	...
	<xsl:template match="rel:Relationships">
		...
		<xsl:for-each select="rel:Relationship[@Type='http://schemas.openxmlformats.org/officeDocument/2006/relationships/notesSlide']">
	...
	<!--添加讲义母版 李娟 2012.04.20-->
		<xsl:for-each select="rel:Relationship[@Type='http://schemas.openxmlformats.org/officeDocument/2006/relationships/handoutMaster']">
		...
		<xsl:for-each select="rel:Relationship[@Type='http://schemas.openxmlformats.org/officeDocument/2006/relationships/theme' or @Type='http://schemas.openxmlformats.org/officeDocument/2006/relationships/themeOverride']">
		...
		<xsl:for-each select="rel:Relationship[@Type='http://schemas.openxmlformats.org/officeDocument/2006/relationships/comments']">
