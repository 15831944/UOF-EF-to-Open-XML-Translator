...
<xsl:template match="a:tbl">
    ...
    <!--<字:文字表 xmlns:uof="http://schemas.uof.org/cn/2003/uof" uof:locID="t0128" uof:attrList="类型">-->
        <!--liuyangyang,2015-03-06，修改表格自动生成样式颜色填充不正确 start-->
        ...
        <xsl:choose>
          ...
          <xsl:when test="name(.)='a:tr'">
            <xsl:call-template name="tblRow">
              ...
              <!--总行数-->
              <xsl:with-param name="totalRowCount" select="count(../a:tr)"/>
              <!--总列数-->
              <xsl:with-param name="totalColumnCount" select="count(./a:tc)"/>
              <!--行号-->
              <xsl:with-param  name="rowCounter" select="position()-2"/>
  ...
  <!--2014-01-13, tangjiang,添加OOXML到UOF文字表式样中填充的转换 start -->
  ...
  <!-- end 2014-01-13, tangjiang,添加OOXML到UOF文字表式样中填充的转换-->
  ...
  <xsl:template match="a:tcPr">
    ...
    <!-- end 2014-01-13, tangjiang,添加OOXML到UOF文字表式样中填充的转换-->
      ...
      <!--2014-01-13, tangjiang,添加OOXML到UOF文字表式样中填充的转换 start -->
      <!--2015-03-06, liuyangyang,修改表格转换样式转换 start -->
      <xsl:choose>
