        ...
        <xsl:choose>
          ...
          <xsl:otherwise>
            <c:catAx>
			  ...
			  <!--zl  2015-4-27-->
              <xsl:if test="./图表:绘图区_E747/图表:坐标轴集_E790/图表:坐标轴_E791/图表:边框线_4226/@线型_C60D='single' and ./图表:绘图区_E747/图表:坐标轴集_E790/图表:坐标轴_E791/图表:边框线_4226/@虚实_C60E='solid'">
                <c:majorGridlines/>
              </xsl:if>
              <!--zl  2015-4-27-->
        ...
        <xsl:if test="./图表:边框线_4226 or ./图表:填充_E746">
          ...
          <c:spPr>
            ...
            <xsl:if test="not(图表:边框线_4226) and not(//图表:绘图区_E747/图表:图表类型组集_E74C/图表:组_E74D/图表:数据系列集_E74E/图表:数据系列_E74F[@类型_E75D='line'])">
              <a:ln w="28575" xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main">
                <a:noFill/>
              </a:ln>
            </xsl:if>
            <!--end-->
  ...
  <xsl:template name="Border">
    ...
    <xsl:if test="./图表:边框线_4226">
      <a:ln>
        ...
        <xsl:if test ="./图表:边框线_4226[@颜色_C611]">
        <a:solidFill>
            <!--<a:schemeClr val="tx1"/>-->
