          ...
          <xsl:if test=".//图:属性_801D/图:透明度_8050">
            <a:alpha>
              <xsl:attribute name="val">
                ...
                <xsl:value-of select="number(100 - number(.//图:属性_801D/图:透明度_8050)) * 1000"/>
  ...
  <xsl:template name="equDrawing" >
    ...
    <xdr:oneCellAnchor>
      ...
      <mc:AlternateContent>
        ...
        <xdr:sp macro="" textlink="" xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main">
          <xdr:nvSpPr>
          ...
          <xsl:if test="./ancestor::uof:UOF/图形:图形集_7C00/图:图形_8062[@标识符_804B=$id]/图:预定义图形_8018/图:属性_801D/图:图片属性_801E/图:图片裁剪_8022">
            <a:srcRect>
              <xsl:attribute name="t">
                <xsl:value-of select="./ancestor::uof:UOF/图形:图形集_7C00/图:图形_8062[@标识符_804B=$id]/图:预定义图形_8018/图:属性_801D/图:图片属性_801E/图:图片裁剪_8022/图:上_8023 * 1000"/>
              </xsl:attribute>
              <xsl:attribute name="b">
                <xsl:value-of select="./ancestor::uof:UOF/图形:图形集_7C00/图:图形_8062[@标识符_804B=$id]/图:预定义图形_8018/图:属性_801D/图:图片属性_801E/图:图片裁剪_8022/图:下_8024 * 1000"/>
              </xsl:attribute>
              <xsl:attribute name="l">
                <xsl:value-of select="./ancestor::uof:UOF/图形:图形集_7C00/图:图形_8062[@标识符_804B=$id]/图:预定义图形_8018/图:属性_801D/图:图片属性_801E/图:图片裁剪_8022/图:左_8025 * 1000"/>
              </xsl:attribute>
              <xsl:attribute name="r">
                <xsl:value-of select="./ancestor::uof:UOF/图形:图形集_7C00/图:图形_8062[@标识符_804B=$id]/图:预定义图形_8018/图:属性_801D/图:图片属性_801E/图:图片裁剪_8022/图:右_8026 * 1000"/>
              </xsl:attribute>
            </a:srcRect>
          </xsl:if>
          <!-- end -->
                                    ...
                                    <xdr:pic>
                                      ...
                                      <xdr:blipFill>
                                        ...
                                        <xsl:if test="./图:预定义图形_8018/图:属性_801D/图:图片属性_801E/图:图片裁剪_8022">
                                          <a:srcRect>
                                            <xsl:attribute name="t">
                                              <xsl:value-of select="./图:预定义图形_8018/图:属性_801D/图:图片属性_801E/图:图片裁剪_8022/图:上_8023 * 1000"/>
                                            </xsl:attribute>
                                            <xsl:attribute name="b">
                                              <xsl:value-of select="./图:预定义图形_8018/图:属性_801D/图:图片属性_801E/图:图片裁剪_8022/图:下_8024 * 1000"/>
                                            </xsl:attribute>
                                            <xsl:attribute name="l">
                                              <xsl:value-of select="./图:预定义图形_8018/图:属性_801D/图:图片属性_801E/图:图片裁剪_8022/图:左_8025 * 1000"/>
                                            </xsl:attribute>
                                            <xsl:attribute name="r">
                                              <xsl:value-of select="./图:预定义图形_8018/图:属性_801D/图:图片属性_801E/图:图片裁剪_8022/图:右_8026 * 1000"/>
                                            </xsl:attribute>
                                          </a:srcRect>
                                        </xsl:if>
                                        <a:stretch>
  ...
  <!--
      <xsl:choose>
        <xsl:when test="($sername!='' and not(contains($sername,$relsheet))) or ($servalue!='' and not(contains($servalue,$relsheet)))">
          <xdr:absoluteAnchor xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main">
            <xdr:pos>
              <xsl:attribute name="x">
