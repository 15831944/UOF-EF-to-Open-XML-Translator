...
<!--xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:w="http://purl.oclc.org/ooxml/wordprocessingml/main" xmlns:uof="http://schemas.uof.org/cn/2003/uof" xmlns:图="http://schemas.uof.org/cn/2003/graph" xmlns:字="http://schemas.uof.org/cn/2003/uof-wordproc" xmlns:表="http://schemas.uof.org/cn/2003/uof-spreadsheet" xmlns:演="http://schemas.uof.org/cn/2003/uof-slideshow" xmlns:pzip="urn:u2o:xmlns:post-processings:special"-->
...
xmlns:pzip="urn:u2o:xmlns:post-processings:special">
  ...
  <xsl:import href="nMasterRels1.xsl"/>
	...
	<xsl:template match="/uof:UOF">
      ...
      <!-- end 2014-03-03, tangjiang -->
			...
			<pzip:entry pzip:target="ppt/tableStyles.xml">
				<a:tblStyleLst xmlns:a="http://purl.oclc.org/ooxml/drawingml/main">
					<xsl:attribute name="def">{5C22544A-7EE6-4342-B048-85BDC9FD1C3A}</xsl:attribute>
				</a:tblStyleLst>
			</pzip:entry>
			<pzip:entry pzip:target="ppt/presProps.xml">
				<p:presentationPr xmlns:a="http://purl.oclc.org/ooxml/drawingml/main" xmlns:r="http://purl.oclc.org/ooxml/officeDocument/relationships" xmlns:p="http://purl.oclc.org/ooxml/presentationml/main">
					                ...
					                <a:effectStyle>
						                <a:effectLst>
							                <a:outerShdw blurRad="40000" dist="23000" dir="5400000" rotWithShape="0">
								                ...
								                <x>8.38989198613408E-05</x>
								                <y>1.81102362010386</y>
							                </a:outerShdw>
						                </a:effectLst>
					                </a:effectStyle>
					                <a:effectStyle>
	...
	<xsl:template name="presentation">
		<p:presentation saveSubsetFonts="1" conformance="strict" xmlns:a="http://purl.oclc.org/ooxml/drawingml/main">
      <!-- 2010.03.25 马有旭 -->
	...
	<xsl:template name="presentation.xml.rels">
		<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
			<Relationship Id="rId7" Type="http://purl.oclc.org/ooxml/officeDocument/relationships/tableStyles" Target="tableStyles.xml"/>
			...
			<Relationship>
				...
				<xsl:attribute name="Type">http://purl.oclc.org/ooxml/officeDocument/relationships/slideMaster</xsl:attribute>
			...
			<xsl:for-each select="uof:演示文稿/演:主体/演:演示文稿文档_6C10/演:幻灯片集_6C0E/演:幻灯片_6C0F">
				<Relationship>
					...
					<xsl:attribute name="Type">http://purl.oclc.org/ooxml/officeDocument/relationships/slide</xsl:attribute>
					<xsl:attribute name="Target">
			...
			<xsl:if test="not(uof:演示文稿/演:主体/演:演示文稿文档_6C10/演:母版集_6C0C/演:母版_6C0D[@类型_6BEA='notes']) and uof:演示文稿/演:主体/演:演示文稿文档_6C10/演:幻灯片集_6C0E/演:幻灯片_6C0F/演:幻灯片备注_6B1D">
				...
				<xsl:for-each select="uof:演示文稿/演:主体/演:演示文稿文档_6C10/演:幻灯片集_6C0E/演:幻灯片_6C0F/演:幻灯片备注_6B1D">
					<Relationship>
						...
						<xsl:attribute name="Type">http://purl.oclc.org/ooxml/officeDocument/relationships/notesMaster</xsl:attribute>
						<xsl:attribute name="Target">
			...
			<xsl:for-each select="uof:演示文稿/演:主体/演:演示文稿文档_6C10/演:母版集_6C0C/演:母版_6C0D[@类型_6BEA][1]">
				...
				<xsl:attribute name="Type">http://purl.oclc.org/ooxml/officeDocument/relationships/theme</xsl:attribute>
				<xsl:attribute name="Target">
					<xsl:choose>
						<xsl:when test="contains(@配色方案引用_6BEB,'clr_')">
      ...
      <!--luowentian 2011-6-1先去掉讲义母版，下期改善>-->
			<xsl:for-each select="uof:演示文稿/演:主体/演:演示文稿文档_6C10/演:母版集_6C0C/演:母版_6C0D[@类型_6BEA='handout']">
				<Relationship>
					...
					<xsl:attribute name="Type">http://purl.oclc.org/ooxml/officeDocument/relationships/handoutMaster</xsl:attribute>
					<xsl:attribute name="Target">
						<xsl:choose>
							<xsl:when test="contains(@标识符_6BE8,'ID')">
			...
			<!--下边3个未验证-->
			<Relationship Id="rId5" Type="http://purl.oclc.org/ooxml/officeDocument/relationships/viewProps" Target="viewProps.xml"/>
			<Relationship Id="rId4" Type="http://purl.oclc.org/ooxml/officeDocument/relationships/presProps" Target="presProps.xml"/>
			<!--添加批注引用 李娟 2012.02.25-->
			<xsl:if  test="//规则:用户集_B667">

				<Relationship Id="rIdcomment" Type="http://purl.oclc.org/ooxml/officeDocument/relationships/commentAuthors" Target="commentAuthors.xml">
