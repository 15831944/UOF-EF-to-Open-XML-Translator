      ...
      <a:solidFill>
        <a:srgbClr>
          ...
          <xsl:if test=".//图:属性_801D/图:透明度_8050">
            <a:alpha>
              <xsl:attribute name="val">
                <xsl:value-of select="concat(round(100-.//图:属性_801D/图:透明度_8050),'%')"/>
              </xsl:attribute>
            </a:alpha>
          </xsl:if>
        </a:srgbClr>
              ...
              <a:path path="rect">
                <a:fillToRect>
                  <xsl:attribute name="l">
                    <xsl:value-of select="concat(.//图:渐变_800D/@种子X位置_8015,'%')"/>
                  </xsl:attribute>
                  <xsl:attribute name="t">
                    <xsl:value-of select="concat(.//图:渐变_800D/@种子Y位置_8016,'%')"/>
                  </xsl:attribute>
                  <xsl:attribute name="r">
                    <xsl:value-of select="concat(100-.//图:渐变_800D/@种子X位置_8015,'%')"/>
                  </xsl:attribute>
                  <xsl:attribute name="b">
                    <xsl:value-of select="concat(100-.//图:渐变_800D/@种子Y位置_8016,'%')"/>
                  </xsl:attribute>
                </a:fillToRect>
              </a:path>
            </xsl:when>
