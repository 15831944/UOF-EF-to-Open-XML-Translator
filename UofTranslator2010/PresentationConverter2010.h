// PresentationConverter2010.h : Declaration of the CPresentationConverter2010
...
class ATL_NO_VTABLE CPresentationConverter2010 :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CPresentationConverter2010, &CLSID_PresentationConverter2010>,
	public IDispatchImpl<IPresentationConverter2010, &IID_IPresentationConverter2010, &LIBID_UofTranslator2010Lib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
	public IConverter
{
public:
	CPresentationConverter2010()
...
DECLARE_REGISTRY_RESOURCEID(IDR_PRESENTATIONCONVERTER2010)


BEGIN_COM_MAP(CPresentationConverter2010)
	COM_INTERFACE_ENTRY(IPresentationConverter2010)
...
OBJECT_ENTRY_AUTO(__uuidof(PresentationConverter2010), CPresentationConverter2010)
